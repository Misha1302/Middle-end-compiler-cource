...
## Concatenated binary
/tmp/diagnostic-concatenated.bin: gzip compressed data, from Unix, original size modulo 2^32 353776220 gzip compressed data, unknown method, ASCII, extra field, has comment, from FAT filesystem (MS-DOS, OS/2, NT), original size modulo 2^32 353776220
