...
20 минут — теория; 100 минут — практическая задача; 10 минут — самостоятельная проверка инвариантов; затем перерыв и разбор со мной. Не открывай предыдущие документы во время первых 130 минут.
