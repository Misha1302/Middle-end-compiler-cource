...
1. Сначала выполни только folding внутри одной инструкции.

2. Затем распространи известные constants по uses.

3. Если условие стало константным, пометь только одно ребро исполнимым.

4. Удали недостижимый блок, исправь φ и после этого запусти DCE.

5. Только затем сравни с SCCP-lattice, если она нужна.
