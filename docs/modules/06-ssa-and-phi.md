...
1.  1\. Найди блоки, где переменная определяется.

2.  2\. По iterated DF расставь кандидаты φ.

3.  3\. Для ромба подпиши: вход из левой ветви несёт одну версию, из правой — другую.

4.  4\. Для цикла в header встречаются initial value из preheader и updated value из latch.

5.  5\. После расстановки φ только начинается renaming — не смешивай два этапа.
