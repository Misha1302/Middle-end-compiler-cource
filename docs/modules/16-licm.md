...
1.  1\. Операнды определены вне цикла или уже признаны инвариантными?

2.  2\. Операция чистая или её эффекты доказанно безопасны?

3.  3\. Может ли раннее выполнение породить исключение/ошибку на пути, где операция раньше не выполнялась?

4.  4\. После hoist определение доминирует все uses и нужные exits?

5.  5\. Только четыре положительных ответа разрешают перенос в preheader.
