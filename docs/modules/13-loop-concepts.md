...
1.  1\. Найди back edge n→h.

2.  2\. Проверь, что h доминирует n.

3.  3\. Начни множество loop с {h,n}.

4.  4\. Иди назад по predecessors от n, пока новые блоки не перестанут добавляться; h не разворачивай дальше.

5.  5\. Отдельно подпиши header, latch, exits и возможный preheader.
