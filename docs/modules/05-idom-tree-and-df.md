...
1.  1\. Из готовых Dom-множеств найди для каждого блока ближайший строгий доминатор.

2.  2\. Нарисуй дерево idom и проверь, что у каждого не-entry блока один родитель.

3.  3\. Для каждого join Y возьми каждого predecessor P.

4.  4\. Поднимай runner=P по idom, пока runner не равен idom(Y); на каждом шаге добавляй Y в DF(runner).

5.  5\. Отдельно проверь DF на ромбе и на цикле.
