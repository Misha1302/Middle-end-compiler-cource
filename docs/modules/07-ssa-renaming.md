...
1.  1\. Создай пустой стек и счётчик для каждой исходной переменной.

2.  2\. В блоке сначала дай новые версии результатам φ и push их.

3.  3\. Замени uses текущими вершинами стеков.

4.  4\. Для обычных definitions создай версии и push.

5.  5\. Для каждого successor заполни соответствующий φ-input текущей версией.

6.  6\. Обойди детей dominator tree.

7.  7\. На выходе pop все версии, созданные именно в текущем блоке.
