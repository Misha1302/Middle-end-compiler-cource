...
1. Запиши все пути от entry к выбранному блоку или используй итерационную таблицу.

2. Для entry оставь только entry. Для остальных сначала предположи множество всех достижимых блоков.

3. На каждой итерации пересекай множества доминаторов всех predecessors и добавляй сам блок.

4. Остановись, когда ни одно множество не изменилось.

5. Проверь каждый неожиданный доминатор контрмаршрутом.
