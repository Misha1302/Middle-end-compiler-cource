...
| **Контрпуть** | путь, который обходит предполагаемый доминатор | одного такого пути достаточно, чтобы опровергнуть доминирование |
...
**Как быстро опровергнуть доминирование?**  
Предъявить один путь от входного блока к цели, который не проходит через кандидата.
